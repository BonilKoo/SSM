...
class myobj():
    ...
    def sanitize_mols(self, row):
        ...
        row['SMILES'] = smiles
        return row
    def read_data(self, train_fname, test_fname):
        ...
        self.train_df  = pd.DataFrame(self.original_data[["SMILES", "label"]])
...
class PrepareData():
    ...
    def read_data(self, train_fname, test_fname):
        self.train_df, self.test_df = self.mydata.read_data(train_fname=train_fname, test_fname = test_fname)
